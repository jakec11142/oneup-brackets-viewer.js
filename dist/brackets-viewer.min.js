...
"use strict";
eval("{\n\nObject.defineProperty(exports, \"__esModule\", ({\n  value: true\n}));\nexports.convertStageStructureToViewerData = void 0;\nconst brackets_model_1 = __webpack_require__(/*! brackets-model */ \"./node_modules/brackets-model/dist/index.js\");\nconst stageTypeMap = {\n  SINGLE_ELIMINATION: 'single_elimination',\n  DOUBLE_ELIMINATION: 'double_elimination',\n  ROUND_ROBIN: 'round_robin',\n  SWISS: 'swiss'\n};\nconst statusMap = {\n  // Uncomplete/Pending states (0) - no badge shown\n  UNCOMPLETE: brackets_model_1.Status.Locked,\n  INCOMPLETE: brackets_model_1.Status.Locked,\n  UNSCHEDULED: brackets_model_1.Status.Locked,\n  PENDING: brackets_model_1.Status.Locked,\n  // Live/Running states (3) - green pulsing LIVE badge\n  LIVE: brackets_model_1.Status.Running,\n  RUNNING: brackets_model_1.Status.Running,\n  IN_PROGRESS: brackets_model_1.Status.Running,\n  // Complete states (4) - gray checkmark badge\n  COMPLETE: brackets_model_1.Status.Completed,\n  COMPLETED: brackets_model_1.Status.Completed,\n  FINISHED: brackets_model_1.Status.Completed\n};\nconst defaultStageNames = {\n  single_elimination: 'Single Elimination',\n  double_elimination: 'Double Elimination',\n  round_robin: 'Round Robin',\n  swiss: 'Swiss Stage'\n};\n/**\n * Converts a structured stage response returned by the API to the shape required by the viewer.\n *\n * @param structure\n * @param standings\n * @param options\n */\nfunction convertStageStructureToViewerData(structure, standings, options = {}) {\n  var _a, _b, _c, _d;\n  if (!structure.stageId) throw new Error('StageStructureResponse.stageId is required');\n  const stageId = structure.stageId;\n  const type = mapStageType(structure.stageType);\n  const stageItems = (_a = structure.stageItems) !== null && _a !== void 0 ? _a : [];\n  const tournamentId = (_b = options.tournamentId) !== null && _b !== void 0 ? _b : stageId;\n  const accumulator = {\n    participants: [],\n    nameToParticipant: new Map(),\n    nextId: 1,\n    tournamentId\n  };\n  // Build team-to-record map from standings data (for Swiss format)\n  const teamRecords = new Map();\n  if (type === 'swiss' && (standings === null || standings === void 0 ? void 0 : standings.groups)) {\n    standings.groups.forEach(group => {\n      var _a;\n      (_a = group.entries) === null || _a === void 0 ? void 0 : _a.forEach(entry => {\n        var _a, _b;\n        if (entry.teamName) {\n          teamRecords.set(entry.teamName, {\n            wins: (_a = entry.wins) !== null && _a !== void 0 ? _a : 0,\n            losses: (_b = entry.losses) !== null && _b !== void 0 ? _b : 0\n          });\n        }\n      });\n    });\n  }\n  // Extract all edges from stage items\n  const edges = [];\n  stageItems.forEach(item => {\n    var _a;\n    if (item.edges) edges.push(...item.edges);\n    (_a = item.rounds) === null || _a === void 0 ? void 0 : _a.forEach(round => {\n      var _a;\n      (_a = round.matches) === null || _a === void 0 ? void 0 : _a.forEach(match => {\n        var _a;\n        ((_a = match.slots) !== null && _a !== void 0 ? _a : []).forEach(slot => ensureParticipant(accumulator, slot.teamName));\n      });\n    });\n  });\n  const matches = [];\n  stageItems.forEach((item, groupIndex) => {\n    var _a, _b;\n    const baseGroupId = (_a = item.id) !== null && _a !== void 0 ? _a : `group-${groupIndex + 1}`;\n    (_b = item.rounds) === null || _b === void 0 ? void 0 : _b.forEach(round => {\n      var _a, _b;\n      // Incorporate bracketGroup into group_id for proper classification\n      const bracketSuffix = round.bracketGroup ? round.bracketGroup.toLowerCase().replace(/_/g, '-') : 'bracket';\n      const groupId = `${baseGroupId}-${bracketSuffix}`;\n      const roundId = `${groupId}-round-${(_a = round.number) !== null && _a !== void 0 ? _a : 1}`;\n      (_b = round.matches) === null || _b === void 0 ? void 0 : _b.forEach((match, matchIndex) => {\n        var _a, _b, _c, _d, _e, _f, _g, _h, _j;\n        const baseMatch = {\n          id: (_a = match.id) !== null && _a !== void 0 ? _a : `${roundId}-match-${matchIndex + 1}`,\n          stage_id: stageId,\n          group_id: groupId,\n          round_id: roundId,\n          number: (_b = match.matchIndex) !== null && _b !== void 0 ? _b : matchIndex + 1,\n          status: mapStatus(match.status),\n          opponent1: convertSlot(accumulator, (_c = match.slots) === null || _c === void 0 ? void 0 : _c[0]),\n          opponent2: convertSlot(accumulator, (_d = match.slots) === null || _d === void 0 ? void 0 : _d[1]),\n          child_count: 0\n        };\n        // SWISS ONLY: Store round date and bestOf metadata for panel headers\n        if (type === 'swiss') {\n          baseMatch.swissRoundDate = round.date;\n          baseMatch.swissRoundBestOf = round.bestOf;\n          // Extract Swiss record (wins-losses) from match ID or team standings\n          let swissWins;\n          let swissLosses;\n          // Method 1: Try to extract from semantic match ID pattern (match-{wins}-{losses}-{index})\n          const swissPattern = /match-(\\d+)-(\\d+)-/;\n          const swissMatch = ((_e = match.id) !== null && _e !== void 0 ? _e : '').toString().match(swissPattern);\n          if (swissMatch) {\n            swissWins = parseInt(swissMatch[1], 10);\n            swissLosses = parseInt(swissMatch[2], 10);\n          }\n          // Method 2: Use team records from standings data (for UUID-style IDs)\n          if (swissWins === undefined || swissLosses === undefined) {\n            const team1Name = (_g = (_f = match.slots) === null || _f === void 0 ? void 0 : _f[0]) === null || _g === void 0 ? void 0 : _g.teamName;\n            const team2Name = (_j = (_h = match.slots) === null || _h === void 0 ? void 0 : _h[1]) === null || _j === void 0 ? void 0 : _j.teamName;\n            if (team1Name && teamRecords.has(team1Name)) {\n              const record = teamRecords.get(team1Name);\n              swissWins = record.wins;\n              swissLosses = record.losses;\n            } else if (team2Name && teamRecords.has(team2Name)) {\n              const record = teamRecords.get(team2Name);\n              swissWins = record.wins;\n              swissLosses = record.losses;\n            }\n          }\n          // Store the extracted Swiss record metadata\n          if (swissWins !== undefined && swissLosses !== undefined) {\n            baseMatch.swissWins = swissWins;\n            baseMatch.swissLosses = swissLosses;\n          }\n        }\n        matches.push(baseMatch);\n      });\n    });\n  });\n  const stageSettings = {\n    size: accumulator.participants.length || undefined,\n    groupCount: type === 'round_robin' || type === 'swiss' ? stageItems.length || 1 : undefined\n  };\n  const stage = {\n    id: stageId,\n    tournament_id: tournamentId,\n    name: (_c = options.stageName) !== null && _c !== void 0 ? _c : defaultStageNames[type],\n    type,\n    settings: stageSettings,\n    number: (_d = options.stageNumber) !== null && _d !== void 0 ? _d : 1\n  };\n  return {\n    stages: [stage],\n    matches,\n    matchGames: [],\n    participants: accumulator.participants,\n    edges\n  };\n}\nexports.convertStageStructureToViewerData = convertStageStructureToViewerData;\n/**\n *\n * @param accumulator\n * @param teamName\n */\nfunction ensureParticipant(accumulator, teamName) {\n  if (!teamName) return null;\n  if (accumulator.nameToParticipant.has(teamName)) return accumulator.nameToParticipant.get(teamName);\n  const participant = {\n    id: accumulator.nextId++,\n    name: teamName,\n    tournament_id: accumulator.tournamentId\n  };\n  accumulator.participants.push(participant);\n  accumulator.nameToParticipant.set(teamName, participant);\n  return participant;\n}\n/**\n *\n * @param accumulator\n * @param slot\n */\nfunction convertSlot(accumulator, slot) {\n  var _a;\n  if (!slot) return null;\n  const participant = ensureParticipant(accumulator, slot.teamName);\n  const result = {\n    id: (_a = participant === null || participant === void 0 ? void 0 : participant.id) !== null && _a !== void 0 ? _a : null\n  };\n  if (slot.sourceRank !== undefined) result.position = slot.sourceRank;\n  if (slot.gamesWon !== undefined) result.score = slot.gamesWon;\n  if (slot.winner) result.result = 'win';\n  if (!participant && slot.teamName) result.result = undefined;\n  return result;\n}\n/**\n *\n * @param type\n */\nfunction mapStageType(type) {\n  if (!type) throw new Error('StageStructureResponse.stageType is required');\n  if (type === 'FFA') throw new Error(`Stage type ${type} is not supported by the viewer`);\n  return stageTypeMap[type];\n}\n/**\n *\n * @param status\n */\nfunction mapStatus(status) {\n  var _a;\n  if (!status) return brackets_model_1.Status.Locked;\n  return (_a = statusMap[status]) !== null && _a !== void 0 ? _a : brackets_model_1.Status.Locked;\n}\n\n//# sourceURL=webpack://brackets-viewer/./src/dto/converter.ts?\n}");
...
"use strict";
eval("{\n\nvar __createBinding = this && this.__createBinding || (Object.create ? function (o, m, k, k2) {\n  if (k2 === undefined) k2 = k;\n  var desc = Object.getOwnPropertyDescriptor(m, k);\n  if (!desc || (\"get\" in desc ? !m.__esModule : desc.writable || desc.configurable)) {\n    desc = {\n      enumerable: true,\n      get: function () {\n        return m[k];\n      }\n    };\n  }\n  Object.defineProperty(o, k2, desc);\n} : function (o, m, k, k2) {\n  if (k2 === undefined) k2 = k;\n  o[k2] = m[k];\n});\nvar __exportStar = this && this.__exportStar || function (m, exports) {\n  for (var p in m) if (p !== \"default\" && !Object.prototype.hasOwnProperty.call(exports, p)) __createBinding(exports, m, p);\n};\nObject.defineProperty(exports, \"__esModule\", ({\n  value: true\n}));\n__exportStar(__webpack_require__(/*! ./types */ \"./src/dto/types.ts\"), exports);\n__exportStar(__webpack_require__(/*! ./converter */ \"./src/dto/converter.ts\"), exports);\n\n//# sourceURL=webpack://brackets-viewer/./src/dto/index.ts?\n}");
...
"use strict";
eval("{\n\nObject.defineProperty(exports, \"__esModule\", ({\n  value: true\n}));\n\n//# sourceURL=webpack://brackets-viewer/./src/dto/types.ts?\n}");
...
"use strict";
eval("{\n\nObject.defineProperty(exports, \"__esModule\", ({\n  value: true\n}));\n\n//# sourceURL=webpack://brackets-viewer/./src/types.ts?\n}");
