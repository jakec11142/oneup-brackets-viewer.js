...
export declare const GROUP_ORDER: BracketGroup[];
/**
 * A point in 2D space.
 */
...
export interface BracketLayout {
    ...
    panelPositions?: SwissPanelPosition[];
    groupOffsetY?: Map<BracketGroup, number>;
    totalWidth: number;
    totalHeight: number;
}
/**
 ...
 */
export declare function extractBracketGroup(groupId: string): BracketGroup;
